 ...
 for ($i=1; $i < 13; $i++) {
  ...
  ?>
     <div class="col-xs-12 col-sm-6 col-md-4 border border-primary ">
       <a href="rdbike-template.php?ID=<?php echo $i;?>">
         <img src="photo/<?php echo $roadb[1]; ?>" alt="mountain" class="mtbikes">
         </a>
         <a href="rdbike-template.php?ID=<?php echo $i;?>" class="linkssh">
         <h3><?php echo $roadb[2] ?></h3>
         <p><?php echo $roadb[3] ?></p>
         <p><?php echo $roadb[6] ?></p>
         </a>
     </div>
     <?php
     }
