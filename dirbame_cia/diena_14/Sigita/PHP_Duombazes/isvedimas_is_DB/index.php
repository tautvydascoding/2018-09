...
// arba dar vienas variantas:
for ($i=0; $i < count($gydytojas) ; $i++) {
  echo $gydytojas[$i] . " "; // kai yra daugiau zmoniu tai labai tinka sitas variantas;
}
 ?>
<!-- // UZDUOTIS 1.2:
// be foreach atspausdinti visa gydytojo info -->
<h2> <em><?php  echo $gydytojas[0] . " " ?></em><?php  echo $gydytojas[1] . " " . $gydytojas[2] . " "?></h2>
