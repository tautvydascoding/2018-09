...
<!-- 1.1 atspaudinti  visa iformacija  apie 3 gydytoja -->
<?php
include("db-functions.php");
$gydytojas = getDoctor(3); //si funkcija suranda duomenu bazeje gydytoja
//print
echo $gydytojas[0] . $gydytojas[1] . $gydytojas[2] . "<br /><br />";
//arba
