...
//------
 ...
 var katinas = "juodas";
 function print(katinas) {
   console.log("konsoles viduje katinas: " + katinas);
 }
print("baltas");
console.log("konsoles isoreje katinas: " + katinas);
