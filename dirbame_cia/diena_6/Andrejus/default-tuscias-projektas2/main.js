...
if (vardas1 == vardas2) {
  ...
  console.log(vardas1 + vardas2,"vardai Nesutampa!!!!");
}

// B)
// Jeigu vardas1 yra "Tomas" - pasisveikinti su juo
if (vardas1 == "Tomas") {
  console.log(vardas1, "labas rytas!");
} else {
  console.log(vardas2, "nesisveikinsiu :(");
}
// C)
// Patikrinti ar varda1 yra "Tomas", IR butinai vardas2  yra "Karolis"
if (vardas1 == "Tomas" && vardas2 == "Karolis") {
  console.log("Leidziam i puslapi");
} else {
...
if (vardas1 == "Tomas" || vardas2 == "Tomas") {
  console.log("tikrai yra Tomas");
} else {
  console.log("tikrai nera Tomu");
}
// ========================================================
// 1 UZDUOTIS
