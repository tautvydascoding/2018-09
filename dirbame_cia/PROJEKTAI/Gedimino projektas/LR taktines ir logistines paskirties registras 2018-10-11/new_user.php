...
<div class="col-3">
  ...
  <input type="Vardas" name="" value="">
  <label class="col-md-4 control-label">Pavardė</label>
  <input type="Pavardė" name="" value="">
  <label class="col-md-4 control-label">Pareigos</label>
  <input type="Vardas" name="" value="">
  <label class="col-md-4 control-label">El.paštas</label>
  <input type="Vardas" name="" value=""> <br>
  <label class="col-md-4 control-label">Prisijungimo.vardas</label>
  <input type="Vardas" name="" value=""> <br>

</div> <br>
<div class="col-3"">
<button type="button" class="btn btn-success">Registruoti</button>
</div>
