...
//------
 ...
 var katinas = "juodas";
pirmas();
 function pirmas (katinas) {
   var katinas = "baltas";
   console.log (katinas);
   console.log (this.katinas);  //this iskviecia is isores esama kintamaji kur juodas
 }
 console.log (katinas);
...
function printStraipsnis (x){
  document.querySelector("h2").innerHTML +=  "<p>" + x + "</p>" ;
}
printAntraste ("pirmas");
printAntraste ("antras");
printAntraste ("trecias");

//  1.3 UZDUOTIS
//  iskviesti f-jaS 3 kartus, kad atspausdintu 3 skirtingas antrastes IR 3 straipnsnius:  "Lorem1 ....",   "Lorem2 ....",   "Lorem3 ....",

function antraste (x, y) {
    document.querySelector("body").innerHTML +="<h3>"+ x+"</h3>"+"<p>" + y  + "</p>" ;

}
antraste ("antraste1", "Lorem1")
antraste ("antraste2", "Lorem2")
antraste ("antraste3", "Lorem2")
