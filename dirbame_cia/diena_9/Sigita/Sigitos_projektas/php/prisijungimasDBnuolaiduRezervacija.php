...
function createRezervacija($vardas, $pavarde, $telNr){
$manoSQL = "INSERT INTO `nuolaidu_rezervacija` VALUES (NULL,'$vardas','$pavarde', '$telNr')"; //butinai kintamieji kabutese, taciau viengubose nes jau yra dvigubos;
