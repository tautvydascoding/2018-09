...
<span
style="background: #ccc;padding: 3px;"><?php  echo $nuol[3];?></span>
<p style="color: red;"><?php  echo $nuol[4];?></p>

                    <!--  forma rezervacijai-->
<form action="create-nuolaidosRezervacija.php" method="get">
    <input type="text" class="form-control" name="Vardas" value="" placeholder="Jūsų vardas" required style="width: 40%; height:30px;"></br>
        <input type="text" class="form-control" name="Pavarde" value="" placeholder="Jūsų pavardė" required style="width: 40%; height:30px;"></br>
            <input type="tel"  class="form-control" name="TelNr" value="" placeholder="Telefono numeris" required style="width: 40%; height:30px;"></br>
...
<div id="tt2" class="icon material-icons">print</div>
    <div class="mdl-tooltip mdl-tooltip--large" for="tt2"> Print</div>
              <!-- jei nenori rezervuoti - mygtukas grizimui i pagrindi puslapi, jei rezervuoja redirect'u grizta -->
