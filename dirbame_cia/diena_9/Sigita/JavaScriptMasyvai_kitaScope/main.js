...
function apieKatina(){
  var katinas = "baltas";
console.log("katinas yra", katinas);
console.log("katinas viduje", this.katinas);
}
apieKatina();
console.log("paskutinis katinas", katinas);
...
function isvesti(xx){
  var xx = 20;
  console.log("pirmasis xx yra", xx);
  console.log("antrasis su zodeliu this", this.xx);
}
isvesti(xx);
console.log("treciasis xx", xx);
 //======================
...
console.log("vardas", vardas);
console.log("su zodeliu this", this.vardas);
}
myName("Petriukas");
...
function printAntraste(x){
  ...
  document.querySelector("h2").innerHTML += "BMW pinga" + " "
  document.querySelector("h2").innerHTML += "Greit pageres orai";
  }
var x = "Reiksme ekrane";
