...
function printKaina (x) {
  ...
  console.log ( x + "<br>");  //+"<br>" - spauzdins teksta is naujos eilutes
...
function pazymiuVidurkis () {
  ...
  document.querySelector("h1").innerHTML +=  vidurkis + "<br>";
}
pazymiuVidurkis ();
...
function pazymiuVidurkis1 (x1, x2, x3, x4, x5) {
  ...
  document.querySelector("h1").innerHTML +=  vidurkis1 + "<br>";

}
pazymiuVidurkis1 (5, 10, 8, 9, 6); //Maryte
pazymiuVidurkis1 (5, 5, 8, 7, 6); //Antanas
pazymiuVidurkis1 (10, 10, 8, 10, 6); //jonas
pazymiuVidurkis1 (5, 5, 8, 7, 6); //Antanas
